# HermesChiWorld Landing Page Revamp
...
- **Imagery**: Use the existing zone art from hermeschiworld.ir (`/assets/hermeschiworld/zones/zone-1..6.jpg`) plus the world hub hero
- **Treatment**: Dark gradients, soft gold glows, thin gold borders on cards, subtle starfield/particles in hero and CTA bands

## Page Sections (top → bottom)

1. **Sticky Nav** — HermesChiWorld wordmark + caduceus sigil, "Preview Build" pill, links (World, Agents, Sigils, Preview, Updates), "Watch Preview" + gold "Enter HermesChiWorld" CTAs
...
9. **Footer** — Stacked logo + tagline, link columns (Enter World, Watch Preview, HermesChi, Updates, Terms, Privacy), social icons (X, Discord, YouTube, GitHub), Sigils disclaimer
...
- Update root `head()` with HermesChiWorld title, description, og tags
